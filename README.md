...
- [x] Persistent live storage (writable overlay that survives reboot)
- [x] Networking stack (dhcpcd, iproute2, openssh) for a system that's actually usable off a LAN
